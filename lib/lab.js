...
const getUniqueWords = function() {};

// 3. Write a function that returns the count of words in a string. Provid the
// *option* to count unique words instead of total words.
